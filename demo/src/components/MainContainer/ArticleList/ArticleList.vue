    ...
    export default {
        ...
        methods:{
            ...
            getArticlesList(type,index){
                ...
                var URL = Vue.prototype.$APIurl + '/v1/article-list' + '?cid='+type+'&page=' + index+'&pageSize=7';
                // console.log(URL)
                var articleList=[];
                var that=this;
                axios.get(URL).then(function (res) {
                    ...
                    //         break;
                    //     case 'shopping':
                    //         that.shopping=articleList;
                    //         break;
                    //     case 'studyArea':
                    //         that.studyArea=articleList;
                    //         break;
                    //     case 'play':
                    //         that.play=articleList;
                    //         break;
                    //     case 'gym':
                    //         that.gym=articleList;
                    //         break;
                    // }
